...
(function () {
    ...
    if (typeof JSON.stringify2 !== 'function') {
        JSON.stringify2 = function (value, replacer, space) {
    ...
    if (typeof JSON.stringify !== 'function') JSON.stringify = JSON.stringify2;
